...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        ...
        <!-- Search Bar -->
        <input type="text" placeholder="Search events..." class="w-full p-3 border rounded-md mt-4">
        ...
        <div class="grid grid-cols-4 gap-4 mt-6">
            ...
            <aside class="col-span-1 bg-white p-4 rounded-lg shadow-md">
                ...
                <div class="space-y-2 mt-2">
                    <label class="flex items-center"><input type="checkbox" checked> All</label>
                    <label class="flex items-center"><input type="checkbox"> Academic</label>
                    <label class="flex items-center"><input type="checkbox"> Sports</label>
                    <label class="flex items-center"><input type="checkbox"> Clubs</label>
                    <label class="flex items-center"><input type="checkbox"> Arts & Culture</label>
                    <label class="flex items-center"><input type="checkbox"> Campus</label>
                </div>
                
                <h2 class="text-xl font-bold mt-4">Date Range</h2>
                <input type="text" class="w-full border p-2 rounded-md mt-2" value="Mar 21, 2025 - Apr 20, 2025">
            ...
            <section class="col-span-3">
                ...
                <div class="flex justify-between items-center mt-6">
                    <h2 class="text-xl font-bold">March 2025</h2>
                    <div>
                        <button class="px-4 py-2 border rounded-md">⬅</button>
                        <button class="px-4 py-2 border rounded-md">➡</button>
                    </div>
                </div>
                <div class="grid grid-cols-7 gap-2 mt-4">
                    ...
                    $days = range(1, 31);
                    foreach ($days as $day) {
                        echo "<div class='p-4 border rounded-md text-center bg-gray-50'>$day</div>";
                    }
                    ?>
                </div>
            </section>
