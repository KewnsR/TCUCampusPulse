...
// Fetch user details
$query = $conn->prepare("SELECT full_name,username, bio, department, year, status, profile_image FROM users WHERE student_number = ?");
...
<body class="bg-gray-100 p-10">
    ...
    <a href="index.php" class="mb-4 inline-block text-gray-600 hover:text-gray-800">&larr; Back to Feed</a>
